...
--
CREATE DATABASE IF NOT EXISTS `dbblooddonor` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;

GRANT ALL PRIVILEGES ON `dbblooddonor`.*
  TO `dbblooddonor`'@'localhost'
  IDENTIFIED BY '`dbblooddonor`';
...
CREATE TABLE IF NOT EXISTS `login` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 AUTO_INCREMENT=1005 ;
